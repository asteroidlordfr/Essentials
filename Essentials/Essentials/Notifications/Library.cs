...
namespace Essentials.Notifications
{
    ...
    public class NotifiLib : BaseUnityPlugin
    {
        private void Awake()
        {
            Logger.LogInfo("[Essentials] The Essentials library is loaded!");
        }
        ...
        private void Init()
        {
            ...
            this.HUDObj2.name = "EssentialsLib";
            this.HUDObj.name = "EssentialsLib";
            ...
            this.Testtext.font = Font.CreateDynamicFontFromOSFont("Cosmic Sans MS", 30);
        ...
        public static void SendNotification(string NotificationText)
        {
            try
            {
                if (IsEnabled && PreviousNotifi != NotificationText)
                {
                    ...
                    NotifiText.text = NotifiText.text = "<b><color=grey>[</color><color=blue>Essentials</color><color=grey>]</color> " + NotificationText + "</b>";
        ...
        private int NotificationDecayTime = 200;
